...
const orderService = {
  ...
  // ✅ Thống kê doanh thu theo ngày/tuần/tháng (chỉ tính hóa đơn Paid)
  getRevenueReport: async (period) => {
    return await Order.getRevenueStats(period);
  },

  // ✅ Tổng quan doanh thu cho các ô thống kê nhanh
  getRevenueSummary: async () => {
    return await Order.getRevenueSummary();
  },
};
