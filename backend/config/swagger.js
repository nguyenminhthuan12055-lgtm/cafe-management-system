...
const options = {
  definition: {
    ...
    paths: {
      ...
      "/api/orders/report/summary": {
        get: {
          summary:
            "Tổng quan nhanh: Tổng doanh thu / Doanh thu hôm nay / Tổng số hóa đơn (chỉ tính hóa đơn Paid, yêu cầu đăng nhập)",
          tags: ["Orders"],
          security: [{ BearerAuth: [] }],
          responses: {
            200: {
              description: "Trả về tổng quan doanh thu.",
              content: {
                "application/json": {
                  schema: {
                    type: "object",
                    properties: {
                      total_revenue: { type: "number", example: 453000 },
                      today_revenue: { type: "number", example: 86000 },
                      total_orders: { type: "integer", example: 11 },
                      total_paid_orders: { type: "integer", example: 6 },
                    },
                  },
                },
              },
      ...
      "/api/orders/report/revenue": {
        get: {
          summary:
            "Thống kê doanh thu theo Ngày / Tuần / Tháng, chỉ tính hóa đơn Paid (yêu cầu đăng nhập)",
          tags: ["Orders"],
          security: [{ BearerAuth: [] }],
          parameters: [
            {
              ...
              description: "Cách gộp nhóm dữ liệu doanh thu",
            },
          ],
          responses: {
            200: { description: "Trả về thống kê doanh thu theo khoảng thời gian được chọn." },
          },
        },
      },
